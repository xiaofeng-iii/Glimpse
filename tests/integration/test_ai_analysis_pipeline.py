...
class TestAIAnalysisPipeline:
    ...
    def test_ocr_text_extraction_is_stored(self, memory_service, sample_image_path, mock_ocr_engine):
        """图片文字识别结果应存入 text_content。"""
